<html>
  ...
  <body>
    ...
    <div id="stickers">
        ...
        <img id="produto" src="pikachu.jpeg" alt="Pikachu"/> 
        <p>Produto: <?=$produto?><br></p>
        <p>Preço: <?=$preco?><br></p>
        <p>Descrição: <?=$descricao?><br></p>


        <img id="produto" src="violao.jpeg" alt="Violão"/>
        <p>Produto: <?=$produto?><br></p>
        <p>Preço: <?=$preco?><br></p>
        <p>Descrição: <?=$descricao?><br></p>


        <img id="produto" src="uni.jpeg" alt="Unicornio"/>
        <p>Produto: <?=$produto?><br></p>
        <p>Preço: <?=$preco?><br></p>
        <p>Descrição: <?=$descricao?><br></p>


        <img id="produto" src="unicorno.jpeg" alt="Unicornio irônico"/> 
        <p>Produto: <?=$produto?><br></p>
        <p>Preço: <?=$preco?><br></p>
        <p>Descrição: <?=$descricao?><br></p>
